...
public class Second extends Fragment {
    ...
    private AnyChartView monthly_chart;

    String months[] = {"January","February","March"};
    int[] earnings = {500, 800, 2000};
    MyDatabaseHelper myDB;

    Button show_monthly_data;
    Activity Display_Monthly_Expenses,MainActivity;
...
//            mParam2 = getArguments().getString(ARG_PARAM2);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        show_monthly_data = view.findViewById(R.id.show_monthly_data);

        myDB = new MyDatabaseHelper(getActivity());


        Cursor cursor2 = myDB.getMonthlyDataForGraph();
        ...
        Cursor cursor = myDB.getMonthlyDataForGraph();
        if(cursor.getCount() == 0){
            Toast.makeText(getActivity(), "No data found..Enter data", Toast.LENGTH_SHORT).show();
        }else {
        ...
        Cursor cursor1 = myDB.getMonthlyDataForGraph1();
        if (cursor1.getCount() == 0){
            Toast.makeText(getActivity(), "No amount,empty value", Toast.LENGTH_SHORT).show();
        }else {
...
//        List<DataEntry> dataEntries = new ArrayList<>();
        ...
        if(count1==1 && count2==1) {
            ...
            pie.title("Current Month Expenses");
            monthly_chart.setChart(pie);
        }else {
            Pie pie = AnyChart.pie();
            List<DataEntry> dataEntries = new ArrayList<>();
        ...
        Display_Monthly_Expenses = getActivity();

        show_monthly_data.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(getActivity(), Display_Monthly_Expenses.class);
